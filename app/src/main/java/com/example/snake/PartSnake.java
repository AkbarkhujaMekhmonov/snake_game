...
public class PartSnake {
    ...
    public Rect getrLeft() {
        return new Rect(this.x-10*Constants.SCREEN_WIDTH/1000,this.y,this.x,this.y+GameView.sizeOfMap);
    }
    ...
    public Rect getrRight() {
        return new Rect(this.x+GameView.sizeOfMap,this.y,this.x+GameView.sizeOfMap+10*Constants.SCREEN_WIDTH/1000,this.y+GameView.sizeOfMap);
    }
