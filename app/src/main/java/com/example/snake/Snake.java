...
public class Snake {
    ...
    private Bitmap bm, bm_head_up, bm_head_down, bm_head_left,bm_head_right, bm_body_vertical, bm_body_horizontal,
            bm_body_top_right, bm_body_top_left, bm_body_bottom_right, bm_body_bottom_left, bm_tail_up, bm_tail_down,
            bm_tail_left, bm_tail_right;
    ...
    public void setBm_head(Bitmap bm_head_up) {
